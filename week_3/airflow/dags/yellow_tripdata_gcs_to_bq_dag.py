...
with DAG(
    ...
    yellow_taxi_gcs_to_gcs_sort_task = GCSToGCSOperator(
            task_id='copy_files',
    ...
    yellow_taxi_gcs_to_gcs_sort_task >> bq_yellow_tripdata_external_table_task >> bq_create_partitioned_table_job
